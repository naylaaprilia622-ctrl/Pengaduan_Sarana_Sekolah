...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-navy/80 text-sm mt-1">Kelola kategori pengaduan yang tersedia untuk siswa</p>
    </div>
...
<div class="bg-white rounded-xl shadow border border-light-brown/30">
    <div class="px-6 py-4 border-b border-light-brown/30">
        <p class="text-sm text-navy/80">Total: <span class="font-semibold text-navy">{{ $kategoris->total() }}</span> kategori</p>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-light-brown/30">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-10 text-center text-navy/70">
